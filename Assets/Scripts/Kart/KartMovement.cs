...
public class KartMovement: MonoBehaviour
{
    ...
    [SerializeField] [Tooltip ("How fast the kart turns its body")] float angularAcceleration;
    [SerializeField] float angularDragGrowth;
    [SerializeField][Tooltip("How quickly the kart changes its movement direction")] float turnBoost;
    ...
    /// <summary>
    /// Moves the kart forward or backwards
    /// </summary>
    /// <param name="direction">If positive the kart goes forward, if negative goes backwards</param>
    ...
    /// <summary>
    /// Makes the kart turn on its y axis
    /// </summary>
